                        ...
                        while($data_siswa_mengikuti_tes = mysqli_fetch_array($sql_siswa_mengikuti_tes)) {
                            ...
                            <tr>
                                ...
                                <td align="center" width="220px">
                                    ...
                                    <a onclick="return confirm('Yakin akan menghapus siswa ini dari daftar peserta ujian?');" href="?page=ujian&action=hapuspeserta&id_tq=<?php echo $id_tq; ?>&id_peserta=<?php echo $data_siswa_mengikuti_tes['id_peserta']; ?>" class="badge" style="background-color:#f00;">Hapus Siswa dari Peserta Ujian</a>
                                </td>
                            </tr>
                        <?php
                        }
