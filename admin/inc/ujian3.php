<div class="page-header">
    <div>
        <h3>Manajemen Data Tes Wawancara </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="#">Home</a>
                </li> 
                <li class="breadcrumb-item active" aria-current="page">Manajemen Data Tes Wawancara </li>
            </ol>
        </nav>
    </div>
</div>
...
$no = 1;
if(@$_SESSION['admin']) {
    $sql_topik = mysqli_query($db, "SELECT * FROM topik_ujian JOIN ruang ON topik_ujian.id_ruang = ruang.id_ruang JOIN bahan_ujian ON topik_ujian.id_bahan_ujian = bahan_ujian.id AND bahan_ujian = 'wawancara' ORDER BY tgl_buat DESC") or die ($db->error);
    $pembuat = "admin";
} else if(@$_SESSION['penguji']) {
    $sql_topik = mysqli_query($db, "SELECT * FROM topik_ujian JOIN ruang ON topik_ujian.id_ruang = ruang.id_ruang JOIN bahan_ujian ON topik_ujian.id_bahan_ujian = bahan_ujian.id WHERE pembuat != 'admin' AND pembuat = '$_SESSION[penguji]' AND bahan_ujian = 'wawancara' ORDER BY tgl_buat DESC") or die ($db->error);
...
<div class="row"> 
            ...
            <div class="col-md-12"> 
                <div class="card">
                    <div class="card-header">
                        <h5>Data Ujian | <a href="?page=ujian3&action=tambah" class="badge badge-primary">Tambah</a></h5>
                    </div>
                    <div class="card-body">
                            ...
                            if(mysqli_num_rows($sql_topik) > 0) {
                                while($data_topik = mysqli_fetch_array($sql_topik)) { ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="?page=ujian3&action=edit&id=<?php echo $data_topik['id_tq']; ?>" class="badge badge-success" >Edit</a>
                                            <a onclick="return confirm('Hati-hati saat menghapus ujian karena Anda akan menghapus semua data yang berhubungan dengan ujian ini, termasuk data soal dan nilai. Apakah Anda tetap yakin akan menghapus ujian ini?');" href="?page=ujian3&action=hapus&id_tq=<?php echo $data_topik['id_tq']; ?>" class="badge badge-danger">Hapus</a>
                                            <a href="?page=ujian3&action=buatsoal3&id=<?php echo $data_topik['id_tq']; ?>" class="badge badge-warning">Buat Soal</a>
                                            <a href="?page=ujian3&action=daftarsoal3&id=<?php echo $data_topik['id_tq']; ?>" class="badge badge-warning">Daftar Soal</a>
                                            <a href="?page=ujian3&action=pesertakoreksi3&id_tq=<?php echo $data_topik['id_tq']; ?>" class="badge badge-warning">Masukan Jawaban</a> 
                                        </td>
                                    </tr>
                                <?php
                                }
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>Tambah Data Ujian | <a href="?page=ujian3" class="badge badge-warning">Kembali</a></h5>
                    </div>
                    <div class="card-body">
                        <form method="post"  enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 wadah_kelas"> 
                                    ...
                                    <a class="tambah_kelas badge badge-info">Tambah Jabatan Lain</a> <small><i>(Klik button untuk menambahkan )</i></small> 
                                    <a href="" style="margin:2px 0; display:none;" class="del-kls badge badge-danger">Delete Ruang Lain</a>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Tanggal Tes Wawancara</label>
                                <div class="col-sm-10">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>Ubah Data Ujian | <a href="?page=peserta_koreksi3" class="badge badge-warning">Kembali</a></h5>
                    </div>
                    <div class="card-body">
                        <?php
...
} else if(@$_GET['action'] == 'buatsoal3') {
    include "buat_soal3.php";
} else if(@$_GET['action'] == 'daftarsoal3') {
    include "daftar_soal3.php";
} else if(@$_GET['action'] == 'pesertakoreksi3') {
    include "peserta_koreksi3.php";
} else if(@$_GET['action'] == 'jawaban') {
    include "jawaban_wawancara.php";
 
} else if(@$_GET['action'] == 'koreksi3') {
    include "koreksi3.php";
    ...
    echo "<script>window.location='?page=ujian3&action=pesertakoreksi3&id_tq=".@$_GET['id_tq']."';</script>";
} ?>