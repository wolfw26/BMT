...
<div class="page-header">
    <div>
        <h3>Manajemen Data Penguji</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="#">Home</a>
                </li> 
                <li class="breadcrumb-item active" aria-current="page">Manajemen Penguji</li>
            </ol>
        </nav>
    </div>
</div>
            ...
            <div class="col-md-12"> 
                <div class="card">
                	<div class="card-header">
                		<h5>Data Penguji | <a href="?page=penguji&action=tambah" class="badge badge-primary">Tambah</a></h5>
                	</div>
                    <div class="card-body">
                        <table id="example1" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql_penguji = mysqli_query($db, "SELECT * FROM penguji") or die ($db->error);
                                if(mysqli_num_rows($sql_penguji) > 0) {
                                    while($data_penguji = mysqli_fetch_array($sql_penguji)) {
                                    ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $data_penguji['nip']; ?></td>
                                            <td><?php echo $data_penguji['nama_lengkap']; ?></td>
                                            <td><?php echo $data_penguji['jenis_kelamin']; ?></td>
                                            <td><?php echo ucfirst($data_penguji['status']); ?></td>
                                            <td align="center" width="170px">
                                                <a href="?page=penguji&action=edit&id=<?php echo $data_penguji['id_penguji']; ?>" class="badge badge-success text-white">Edit</a>
                                                <a onclick="return confirm('Yakin akan menghapus data penguji?');" href="?page=penguji&action=hapus&id=<?php echo $data_penguji['id_penguji']; ?>" class="badge text-white badge-danger">Hapus</a>
                                                <a href="?page=penguji&action=detail&id=<?php echo $data_penguji['id_penguji']; ?>" class="badge badge-info text-white">Detail</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
