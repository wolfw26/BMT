            ...
            <div class="col-md-12"> 
                <div class="card">
                	<div class="card-header">
						Lihat Daftar Jenis Soal : <a href="?page=ujian2&action=daftarsoal2&hal=pilgan&id=<?php echo $id; ?>" class="badge badge-primary">Tertulis (<?php echo mysqli_num_rows($sql_pilgan); ?> soal)</a>  
						<a href="?page=ujian2" class="badge badge-danger">Kembali</a> &nbsp; 
					</div>
					<?php
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12"> 
                <div class="card">
                	<div class="card-header">
						Soal Ujian Tertulis &nbsp; <a href="?page=ujian2&action=buatsoal2&hal=soalpilgan&id=<?php echo $id; ?>" class="badge badge-primary">Tambah Soal Ujian Tertulis</a>
					</div>
					<div class="card-body">
						<?php
									...
									<table class="table table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td>:</td>
												<td>
													<a href="?page=ujian2&action=daftarsoal2&hal=editsoalpilgan&id=<?php echo $id; ?>&idsoal=<?php echo $data_pilgan['id_pilgan']; ?>&ke=<?php echo $k++; ?>" class="badge badge-success">Edit</a>
													<a onclick="return confirm('Yakin akan menghapus data?');" href="?page=ujian2&action=daftarsoal2&hal=hapussoalpilgan&id=<?php echo $id; ?>&idsoal=<?php echo $data_pilgan['id_pilgan']; ?>" class="badge badge-danger">Hapus</a>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<?php
							...
							<div class="alert alert-danger">Data Soal Ujian Tertulis tidak ditemukan</div>
							<?php
						} ?>
					</div>
				</div>
...
<div class="row"> 
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12"> 
                <div class="card">
                	<div class="card-header">
                		Soal Essay &nbsp; <a href="?page=ujian2&action=buatsoal2&hal=soalessay&id=<?php echo $id; ?>" class="badge badge-primary">Tambah Soal Wawancara</a>
                	</div> 
					<div class="card-body">
								...
								if(mysqli_num_rows($sql_essay) > 0) {
									...
									<tr>
										...
										<td align="center" width="120px">
											<a href="?page=ujian2&action=daftarsoal2&hal=editsoalessay&id=<?php echo $id; ?>&idsoal=<?php echo $data_essay['id_essay']; ?>&ke=<?php echo $k++; ?>" class="badge badge-success">Edit</a>
											<a onclick="return confirm('Yakin akan menghapus data?');" href="?page=ujian2&action=daftarsoal2&hal=hapussoalessay&id=<?php echo $id; ?>&idsoal=<?php echo $data_essay['id_essay']; ?>" class="badge badge-danger">Hapus</a>
										</td>
									</tr>
									<?php
									}
	...
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">Edit Soal Ujian Tertulis</div>
			...
			?>
							...
							if($data_pilgan_id['gambar'] != '') {
								if(@$_GET['gbr'] != 'del') { ?>
									<div style="margin-top:5px;">
										...
										<br /> <small><a href="?page=ujian2&action=daftarsoal2&hal=editsoalpilgan&id=<?php echo $id; ?>&idsoal=<?php echo $data_pilgan_id['id_pilgan']; ?>&ke=<?php echo $ke; ?>&gbr=del">Hapus Gambar</a></small>
									</div>
								<?php }
							} ?>
						</div>
				...
				if(@$_POST['simpan']) {
					...
					echo "<script>window.location='?page=ujian2&action=daftarsoal2&hal=pilgan&id=".$id."';</script>";
				} ?>
		...
		<div class="panel panel-default">
			...
			?>
	            ...
	            if(@$_POST['simpan']) {
                    ...
                    echo '<script>window.location="?page=ujian2&action=daftarsoal2&hal=essay&id='.$id.'"</script>';
	            } ?>
