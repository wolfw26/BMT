            ...
            <div class="col-md-12"> 
                <div class="card">
                	<div class="card-header">
				        ...
				        Buat Jenis Soal : 
				        <a href="?page=ujian3&action=buatsoal3&hal=soalessay&id=<?php echo $id; ?>" class="badge badge-primary">Ujian Wawancara</a>  
					    ...
					    <div class="card-header">
					        ...
					        while($data_kelas_lain = mysqli_fetch_array($sql_kelas_lain)){
				                ...
				                <label class="checkbox-inline">
				                    <input type="checkbox" name="kls[]" value="<?php echo $data_nm_kls['kandidat']; ?>"><?php echo $data_nm_kls['kandidat']; ?>
				                </label>
								<?php
				            ...
				            if(@$_POST['simpan']) {
				            	...
				            	for($o = 0; $o < $cek; $o++) {
					            	...
					            	if (in_array($kls, $b)) {
					            		...
					            		if($kls != "") {
						            		$sql_tq_kls = mysqli_query($db, "SELECT * FROM topik_ujian JOIN ruang WHERE id_tq = '$a[$o]' AND kandidat = '$kls'") or die ($db->error);
					    ...
					    <div class="card-body">
				            ...
				            if(@$_POST['simpan']) {
				            	...
				            	for($p = 0; $p < $cek; $p++) {
					            	...
					            	if (in_array($kls2, $c)) {
					            		if($kls2 != "") {
						            		$sql_tq_kls2 = mysqli_query($db, "SELECT * FROM topik_ujian JOIN ruang WHERE id_tq = '$a[$p]' AND kandidat = '$kls2'") or die ($db->error);
