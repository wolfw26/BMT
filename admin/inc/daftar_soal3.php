            ...
            <div class="col-md-12"> 
                <div class="card">
                	<div class="card-header">
						Lihat Daftar Jenis Soal : 
						<a href="?page=ujian3&action=daftarsoal3&hal=essay&id=<?php echo $id; ?>" class="badge badge-primary">Wawancara (<?php echo mysqli_num_rows($sql_essay); ?> soal)</a>
						<a href="?page=ujian3" class="badge badge-danger">Kembali</a> &nbsp; 
					</div>
					<?php
					if(@$_GET['hal'] == "pilgan" || @$_GET['hal'] == "essay") { ?>
					<div class="card-body">
						<fieldset>
							<legend>Informasi Ujian3</legend>
							<?php
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12"> 
                <div class="card">
                	<div class="card-header">
						Soal Pilihan Ganda &nbsp; <a href="?page=ujian3&action=buatsoal3&hal=soalpilgan&id=<?php echo $id; ?>" class="badge badge-primary">Tambah Soal Pilihan Ganda</a>
					</div>
					<div class="card-body">
						<?php
									...
									<table class="table table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td>:</td>
												<td>
													<a href="?page=ujian3&action=daftarsoal3&hal=editsoalpilgan&id=<?php echo $id; ?>&idsoal=<?php echo $data_pilgan['id_pilgan']; ?>&ke=<?php echo $k++; ?>" class="badge badge-success">Edit</a>
													<a onclick="return confirm('Yakin akan menghapus data?');" href="?page=ujian3&action=daftarsoal3&hal=hapussoalpilgan&id=<?php echo $id; ?>&idsoal=<?php echo $data_pilgan['id_pilgan']; ?>" class="badge badge-danger">Hapus</a>
												</td>
											</tr>
										</tbody>
									</table>
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12"> 
                <div class="card">
                	<div class="card-header">
                		Soal Essay &nbsp; <a href="?page=ujian3&action=buatsoal3&hal=soalessay&id=<?php echo $id; ?>" class="badge badge-primary">Tambah Soal Wawancara</a>
                	</div> 
					<div class="card-body">
								...
								if(mysqli_num_rows($sql_essay) > 0) {
									...
									<tr>
										...
										<td align="center" width="120px">
											<a href="?page=ujian3&action=daftarsoal3&hal=editsoalessay&id=<?php echo $id; ?>&idsoal=<?php echo $data_essay['id_essay']; ?>&ke=<?php echo $k++; ?>" class="badge badge-success">Edit</a>
											<a onclick="return confirm('Yakin akan menghapus data?');" href="?page=ujian3&action=daftarsoal3&hal=hapussoalessay&id=<?php echo $id; ?>&idsoal=<?php echo $data_essay['id_essay']; ?>" class="badge badge-danger">Hapus</a>
										</td>
									</tr>
									<?php
									}
		...
		<div class="panel panel-default">
			...
			?>
							...
							if($data_pilgan_id['gambar'] != '') {
								if(@$_GET['gbr'] != 'del') { ?>
									<div style="margin-top:5px;">
										...
										<br /> <small><a href="?page=ujian3&action=daftarsoal3&hal=editsoalpilgan&id=<?php echo $id; ?>&idsoal=<?php echo $data_pilgan_id['id_pilgan']; ?>&ke=<?php echo $ke; ?>&gbr=del">Hapus Gambar</a></small>
									</div>
								<?php }
							} ?>
						</div>
				...
				if(@$_POST['simpan']) {
					...
					echo "<script>window.location='?page=ujian3&action=daftarsoal3&hal=pilgan&id=".$id."';</script>";
				} ?>
		...
		<div class="panel panel-default">
			...
			?>
	            ...
	            if(@$_POST['simpan']) {
                    ...
                    echo '<script>window.location="?page=ujian3&action=daftarsoal3&hal=essay&id='.$id.'"</script>';
	            } ?>
