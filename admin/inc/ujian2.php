<div class="page-header">
    <div>
        <h3>Manajemen Data Ujian Tertulis</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="#">Home</a>
                </li> 
                <li class="breadcrumb-item active" aria-current="page">Manajemen Ujian Tertulis</li>
            </ol>
        </nav>
    </div>
</div>
...
$no = 1;
if(@$_SESSION['admin']) {
    $sql_topik = mysqli_query($db, "SELECT * FROM topik_ujian JOIN ruang ON topik_ujian.id_ruang = ruang.id_ruang JOIN bahan_ujian ON topik_ujian.id_bahan_ujian = bahan_ujian.id AND bahan_ujian = 'tertulis' ORDER BY tgl_buat DESC") or die ($db->error);
    $pembuat = "admin";
} else if(@$_SESSION['penguji']) {
    $sql_topik = mysqli_query($db, "SELECT * FROM topik_ujian JOIN ruang ON topik_ujian.id_ruang = ruang.id_ruang JOIN bahan_ujian ON topik_ujian.id_bahan_ujian = bahan_ujian.id WHERE pembuat != 'admin' AND pembuat = '$_SESSION[penguji]' AND bahan_ujian = 'tertulis' ORDER BY tgl_buat DESC") or die ($db->error);
...
<div class="row"> 
            ...
            <div class="col-md-12"> 
                <div class="card">
                	<div class="card-header">
                        <h5>Data Ujian | <a href="?page=ujian2&action=tambah" class="badge badge-primary">Tambah</a></h5>
                    </div>
                    <div class="card-body">
                            ...
                            if(mysqli_num_rows($sql_topik) > 0) {
                                while($data_topik = mysqli_fetch_array($sql_topik)) { ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="?page=ujian2&action=edit&id=<?php echo $data_topik['id_tq']; ?>" class="badge badge-success" >Edit</a>
                                            <a onclick="return confirm('Hati-hati saat menghapus ujian karena Anda akan menghapus semua data yang berhubungan dengan ujian ini, termasuk data soal dan nilai. Apakah Anda tetap yakin akan menghapus ujian ini?');" href="?page=ujian2&action=hapus&id_tq=<?php echo $data_topik['id_tq']; ?>" class="badge badge-danger">Hapus</a>
                                            <a href="?page=ujian2&action=buatsoal2&id=<?php echo $data_topik['id_tq']; ?>" class="badge badge-warning">Buat Soal</a>
                                            <a href="?page=ujian2&action=daftarsoal2&id=<?php echo $data_topik['id_tq']; ?>" class="badge badge-warning">Daftar Soal</a>
                                            <a href="?page=ujian2&action=pesertakoreksi2&id_tq=<?php echo $data_topik['id_tq']; ?>" class="badge badge-warning">Peserta & Koreksi</a> 
                                        </td>
                                    </tr>
                                <?php
                                }
	...
	<div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>Tambah Data Ujian | <a href="?page=ujian2" class="badge badge-warning">Kembali</a></h5>
                    </div>
                    <div class="card-body">
	...
	<div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>Ubah Data Ujian | <a href="?page=ujian2" class="badge badge-warning">Kembali</a></h5>
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        if(isset($_POST['simpan'])){
                            ...
                            echo "<script>window.location='?page=ujian2';</script>";
                        }
                        ?>
                    </div>
                </div> 
...
} else if(@$_GET['action'] == 'buatsoal2') {
    include "buat_soal2.php";
} else if(@$_GET['action'] == 'daftarsoal2') {
    include "daftar_soal2.php";
} else if(@$_GET['action'] == 'pesertakoreksi2') {
    include "peserta_koreksi2.php";
 
} else if(@$_GET['action'] == 'koreksi2') {
    include "koreksi2.php";
    ...
    echo "<script>window.location='?page=ujian2&action=pesertakoreksi2&id_tq=".@$_GET['id_tq']."';</script>";
} ?>