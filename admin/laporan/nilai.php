	    ...
	    <div class="page">
	        <div class="subpage">
	        	...
	        	<table width="100%">
			        <tbody>
			            <tr>
			                <td>
                                <a href="#">
                                    <img src="BMT.png" width="150" height="100" style="vertical-align: middle;">
                                </a>
                            </td>
                            <td align="left">
			    ...
			    <table class="item_entry" width="100%" class="table display nowrap">
					...
					<tbody>
					<?php $no=1; ?>
                        <?php $ambil=$con->query("SELECT * FROM peserta INNER JOIN ruang ON peserta.id_ruang = ruang.id_ruang"); ?>
