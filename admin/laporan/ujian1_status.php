...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Laporan seleksi adminstrasi</title>
	</head>
	<style type="text/css">
        .item_entry
        {
	    ...
	    <div class="page">
	        <div class="subpage">
				...
				<p style="font-size: 14px;" align="center">
			    	<b>LAPORAN SELEKSI ADMINISTRASI</b> <br> <small> Berdasarkan Status <?php echo $berkas['status_berkas'] ?></small>
			    </p> <br>
			    ...
			    <table class="item_entry" width="100%" class="table display nowrap">
					...
					<tbody>
						<?php $nomor=1; ?>
                        <?php $ambil=$con->query("SELECT * FROM berkas natural join peserta WHERE status_berkas='$status_berkas' ORDER BY nama_lengkap ASC"); ?>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px;"><?php echo $pecah['alamat']; ?></td> 
                            <td style="font-size: 12px;"><?php echo $pecah['status_berkas']; ?></td> 
                        </tr>
                        <?php $nomor++; ?>
                        <?php } ?>
                    </tbody>
