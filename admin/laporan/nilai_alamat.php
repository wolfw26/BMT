...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <link rel="shortcut icon" href="bawas.png"/>
	    ...
	    <div class="page">
	        <div class="subpage">
	        	...
	        	<table width="100%">
			        <tbody>
			            <tr>
			                <td>
                                <a href="#">
                                    <img src="BMT.png" width="75" height="80" style="vertical-align: middle;">
                                </a>
                            </td>
                            <td align="left">
                ...
                <p style="font-size: 14px;" align="center">
			    	<b>LAPORAN PENILAIAN</b> <br> <small> Berdasarkan Jabatan<?php echo $data_ruang['kandidat'] ?></small>
			    </p> <br>
			    ...
			    <table class="item_entry" width="100%" class="table display nowrap">
					<thead>
						<tr align="left">
							...
							<th style="font-size: 12px; vertical-align: middle; color: black;" align="center">KECAMATAN</th> 
                    ...
                    <?php $no=1; ?>
                        <?php $ambil=$con->query("SELECT * FROM peserta INNER JOIN ruang INNER JOIN penilaian ON peserta.id_ruang = ruang.id_ruang WHERE peserta.id_ruang='$ruang' ORDER BY kandidat ASC"); ?>
						<?php while ($pecah = $ambil->fetch_assoc()){
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $pecah['kandidat']; ?></td>
                                            <?php
                                            $sql_pilgan = $con->query("SELECT * FROM nilai_pilgan WHERE id_peserta = '$pecah[id_peserta]'");$data_pilgan = $sql_pilgan->fetch_assoc();

                                            $sql_essay =  $con->query("SELECT * FROM nilai_essay WHERE id_peserta = '$pecah[id_peserta]'");
                                            $data_essay = $sql_essay->fetch_assoc();
