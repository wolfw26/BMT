...
$ruang = $_POST['ruang'];
    $tampil= mysqli_query($con, "SELECT * FROM ruang WHERE id_ruang='$ruang'");
	$data_ruang = mysqli_fetch_array($tampil);
    {
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>LAPORAN PESERTA PERJABATAN</title>
	</head>
	<style type="text/css">
        .item_entry
        {
	    ...
	    <div class="page">
	        <div class="subpage">
			    ...
			    <p style="font-size: 14px;" align="center">
			    	<b>LAPORAN CALON KARYAWAN</b> <br> <small> Berdasarkan Jabatan <?php echo $data_ruang['kandidat'] ?></small>
			    </p> <br>
			    ...
			    <table class="item_entry" width="100%" class="table display nowrap">
					...
					<tbody>
						<?php $nomor=1; ?>
                        <?php $ambil=$con->query("SELECT * FROM peserta INNER JOIN ruang ON peserta.id_ruang = ruang.id_ruang WHERE peserta.id_ruang='$ruang' ORDER BY kandidat ASC"); ?>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px;"><?php echo $pecah['tempat_lahir']; ?>, <?php echo $tgl1; ?></td>
                            <td style="font-size: 12px;"><?php echo $pecah['no_telp']; ?></td> 
                            <td style="font-size: 12px;"><?php echo $pecah['kandidat']; ?></td> 
                        </tr>
                        <?php $nomor++; ?>
                        <?php } ?>
                    </tbody>
	    		...
	    		<table align="right">
		            ...
		            <tr>
					<th align="center" style="font-size: 12px"><u><br>HUSMAWAN<br>HOD HRGA</u></th>
		            </tr> 
	            </table>
...
<script type="text/javascript">window.print_r();</script>
<?php } ?>  