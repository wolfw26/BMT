...
--
-- Struktur dari tabel `bahan_ujian`
--
...
--
-- Dumping data untuk tabel `bahan_ujian`
--
...
--
-- Struktur dari tabel `bahan_ujian_ajar`
--
...
(17, '0110101001', 'loremipsum', 'bjm', '2023-08-16', 'L', 'islam', '087763663667', 'lorem@ipsum.com', 'bjm', 'OM', 'sfhbgfhbgfbb.jpg', 'loremipsum', 'loremipsum', 'loremipsum', 'aktif');
...
(5, 25, 80, 70, 75, 'B', 'Baik - Lolos'),
(6, 26, 80, 70, 75, 'B', 'Baik - Lolos'),
(7, 69, 30, 80, 110, 'B', 'Baik - Lolos');
...
(61, '1234567890', 'Mira', 'balangan', '2023-01-30', 'P', 'Islam', '081253301843', 'mira@gmail.com', 'Adhyaksa', 9, '1.jpg', 'mira', 'cf5bdfb40421ac1f30cc4d45b66b5a81', 'mira', 'aktif'),
(62, '1234567890', 'halimah', 'suryakanta', '2023-02-07', 'P', 'Islam', '081253301843', 'halimah@gmail.com', 'Adhyaksa', 6, '1.jpg', 'halimah', 'aebf7e2d1e862f1231903aac4c5331e7', 'halimah', 'aktif'),
(64, '20', 'Wulan', 'Banjarmasin', '2023-02-01', 'P', 'Islam', '081253301843', 'Wulan@gmail.com', 'Kuin Utara', 6, 'wulan', 'wulan', 'wulan', 'wulan', 'aktif'),
(65, '22', 'Jaya', 'Handil', '2023-02-14', 'L', 'Islam', '081253301843', 'Jaya@gmail.com', 'Liang Anggang', 14, '', 'Jaya', 'jaya', 'jaya', 'aktif'),
(67, '24', 'Nisa', 'Negara', '2023-02-09', 'P', 'Islam', '081253301843', 'Nisa@gmail.com', 'Negara', 14, 'nisa', 'nisa', 'nisa', 'nisa', 'aktif'),
(68, '25', 'Bani', 'Sugara', '2023-02-01', 'P', 'Islam', '083748578637', 'bani@gmail.com', 'sugara', 10, 'sugara', 'bani', 'bani', 'bani', 'aktif'),
(69, '26', 'Julian', 'Banjarmasin', '2023-02-07', 'L', 'Islam', '081253301843', 'Banjarmasin', 'julian@gmail.com', 9, 'julian', 'julian', 'julian', 'julian', 'aktif');
...
--
-- Struktur dari tabel `ruang_ajar`
--
...
--
-- Dumping data untuk tabel `ruang_ajar`
--
...
--
-- Struktur dari tabel `topik_ujian`
--
...
--
-- Dumping data untuk tabel `topik_ujian`
--
...
--
-- Indeks untuk tabel `bahan_ujian`
--
ALTER TABLE `bahan_ujian`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `bahan_ujian_ajar`
--
...
--
-- Indeks untuk tabel `topik_ujian`
--
...
--
-- AUTO_INCREMENT untuk tabel `bahan_ujian`
--
ALTER TABLE `bahan_ujian`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `bahan_ujian_ajar`
--
ALTER TABLE `bahan_ujian_ajar`
...
--
ALTER TABLE `penguji`
  MODIFY `id_penguji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- AUTO_INCREMENT untuk tabel `ruang_ajar`
--
ALTER TABLE `ruang_ajar`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `soal_essay`
  MODIFY `id_essay` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `pelatihan`
  ADD CONSTRAINT `pelatihan_ibfk_1` FOREIGN KEY (`id_peserta`) REFERENCES `peserta` (`id_peserta`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pelatihan_ibfk_2` FOREIGN KEY (`id_nilai`) REFERENCES `penilaian` (`id_nilai`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `peserta`
--
ALTER TABLE `peserta`
  ADD CONSTRAINT `peserta_ibfk_1` FOREIGN KEY (`id_ruang`) REFERENCES `ruang` (`id_ruang`) ON DELETE CASCADE;
COMMIT;
